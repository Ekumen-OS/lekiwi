...
def mobile_base() -> LeKiwiMobileBase:
    ...
    return LeKiwiMobileBase(wheel_radius=0.05, robot_base_radius=0.125)


class TestLeKiwiMobileBase:
    """Test suite for the LeKiwiMobileBase kinematics."""

    def test_initialization(self, mobile_base: LeKiwiMobileBase):
        """Test the initialization of the LeKiwiMobileBase."""
        assert mobile_base.wheel_radius == 0.05
        assert mobile_base.robot_base_radius == 0.125
    ...
    def test_forward_kinematics_pure_forward(self, mobile_base: LeKiwiMobileBase):
    ...
    def test_forward_kinematics_pure_sideways(self, mobile_base: LeKiwiMobileBase):
    ...
    def test_forward_kinematics_pure_rotation(self, mobile_base: LeKiwiMobileBase):
    ...
    def test_inverse_kinematics_pure_forward(self, mobile_base: LeKiwiMobileBase):
    ...
    def test_inverse_kinematics_pure_sideways(self, mobile_base: LeKiwiMobileBase):
    ...
    def test_inverse_kinematics_pure_rotation(self, mobile_base: LeKiwiMobileBase):
    ...
    def test_round_trip_consistency(self, mobile_base: LeKiwiMobileBase):
    ...
    def test_invalid_input_shape(self, mobile_base: LeKiwiMobileBase):
